srcdir = /soft/php/php-excel-writer
builddir = /soft/php/php-excel-writer
top_srcdir = /soft/php/php-excel-writer
top_builddir = /soft/php/php-excel-writer
EGREP = /bin/grep -E
SED = /bin/sed
CONFIGURE_COMMAND = './configure' '--with-php-config=/usr/local/php-7.2.0/bin/php-config'
CONFIGURE_OPTIONS = '--with-php-config=/usr/local/php-7.2.0/bin/php-config'
SHLIB_SUFFIX_NAME = so
SHLIB_DL_SUFFIX_NAME = so
ZEND_EXT_TYPE = zend_extension
RE2C = exit 0;
AWK = gawk
EXCEL_WRITER_SHARED_LIBADD = -Wl,-rpath,/usr/local/lib -L/usr/local/lib -lxlsxwriter
shared_objects_excel_writer = excel_writer.lo kernel/exception.lo kernel/excel.lo kernel/write.lo
PHP_PECL_EXTENSION = excel_writer
PHP_MODULES = $(phplibdir)/excel_writer.la
PHP_ZEND_EX =
all_targets = $(PHP_MODULES) $(PHP_ZEND_EX)
install_targets = install-modules install-headers
prefix = /usr/local/php-7.2.0
exec_prefix = $(prefix)
libdir = ${exec_prefix}/lib
prefix = /usr/local/php-7.2.0
phplibdir = /soft/php/php-excel-writer/modules
phpincludedir = /usr/local/php-7.2.0/include/php
CC = cc
CFLAGS = -g -O2
CFLAGS_CLEAN = $(CFLAGS)
CPP = cc -E
...
EXTENSION_DIR = /usr/local/php-7.2.0/lib/php/extensions/no-debug-non-zts-20170718
PHP_EXECUTABLE = /usr/local/php-7.2.0/bin/php
EXTRA_LDFLAGS =
EXTRA_LIBS =
INCLUDES = -I/usr/local/php-7.2.0/include/php -I/usr/local/php-7.2.0/include/php/main -I/usr/local/php-7.2.0/include/php/TSRM -I/usr/local/php-7.2.0/include/php/Zend -I/usr/local/php-7.2.0/include/php/ext -I/usr/local/php-7.2.0/include/php/ext/date/lib -I/usr/local/include
LFLAGS =
LDFLAGS =
SHARED_LIBTOOL =
